...
export default {
  ...
  computed: {
    ...
    bottomOfScreen() {
      return this.topOfScreen + (this.scrollContainerSelector ? this.scrollContainer.clientHeight : this.scrollContainer.innerHeight);
    },
  ...
  methods: {
    ...
    onScroll() {
      ...
      const shouldUseScrollAffix = this.scrollAffix
        && affixTotalHeight > (this.scrollContainerSelector ? this.scrollContainer.clientHeight : this.scrollContainer.innerHeight);
